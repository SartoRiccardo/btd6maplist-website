...
export default async function MySubmissions({ searchParams }) {
  ...
  const completionGroups =
    submissionType === "completion"
      ? groupConsecutiveCompsByMap(submissions.data)
      : [];
  ...
  return (
    <>
      ...
      <div className="d-flex justify-content-center my-3">
        <Link href="/my-submissions?type=map" data-cy="map-button">
          <span
            className={`btn btn-primary ${
              submissionType === "map" ? "active" : ""
            }`}
          >
            Maps
          </span>
        ...
        <Link
          href="/my-submissions?type=completion"
          data-cy="completions-button"
        >
          <span
            className={`btn btn-primary ${
              submissionType === "completion" ? "active" : ""
            } ms-2`}
          >
            Completions
          </span>
